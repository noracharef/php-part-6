...
<head>
    ...
    <title>Exerice php partie 6 exercice 3</title>
...
<body>
    <nav>
        ...
        <h2>Exercice 3<h2>
                <p>Avec le formulaire de l'exercice 1, afficher dans la page user.php les données du formulaire transmises.
                </p>

                <form method="GET" action="userex3.php">
                    <div>
                ...
                <a href="userex3.php?lastname=Roberts&firstname=Julia">Test</a>
</body>
